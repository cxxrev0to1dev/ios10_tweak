...
HOOK_MESSAGE(id,SKUIStorePageSectionsViewController,collectionView,id arg1,id arg2){
  //AFLog(@"func:%s line:%d",__FUNCTION__,__LINE__);
  id result;
...
HOOK_MESSAGE(void,SKUIStorePageSectionsViewController,scrollViewWillEndDragging,id arg1,struct CGPoint arg2,struct CGPoint* arg3){
  //AFLog(@"func:%s line:%d",__FUNCTION__,__LINE__);
  _SKUIStorePageSectionsViewController_scrollViewWillEndDragging(self,sel,arg1,arg2,arg3);
}
HOOK_MESSAGE(id,SKUIStorePageSectionsViewController,viewWillAppear,bool arg1){
  //AFLog(@"func:%s line:%d",__FUNCTION__,__LINE__);
...
HOOK_MESSAGE(id,SKUIStorePageSectionsViewController,viewWillDisappear,bool arg1){
  //AFLog(@"func:%s line:%d",__FUNCTION__,__LINE__);
...
HOOK_MESSAGE(id,SKUIStorePageSectionsViewController,dealloc){
  //AFLog(@"func:%s line:%d",__FUNCTION__,__LINE__);
